		...
		<div class="post-container">
			<form action="PostInsertController" method="post"
				...
				<input type="hidden" formaction="PostInsertController"
					name="postType" value="Q"> <input type="radio"
					formaction="PostInsertController" name="isAnonymous" value="F"
					checked="checked"> 실명으로 작성 <input type="radio"
					formaction="PostInsertController" name="isAnonymous" value="T">
				익명으로 작성
