			...
			<a href="QnaContent.jsp?idx=<%=post.getPost_id()%>" class="link">
				<div class="quest-container-in">
					...
					<div class="res-container">
						<span>답변</span> <span class="res-icon"><ion-icon
								name="chatbox-outline"></ion-icon></span> <span><%=dao.ansCount(post.getPost_id())%></span>
			...
			$.ajax({
				...
				success : function(data) {
					...
					for (var i = 0; i < data.length; i++) {
						...
						//채택여부
						let adopt = "답변대기";
						addHtml += "<div class='adopt-container'><div class='unAdopted'>"
						if(post.answer_cnt>0){
							adopt = "채택대기";
						}
						if(post.is_adopted=="T"){
							addHtml = "<div class='adopt-container'><div class='adopted'>"
							adopt = "채택완료";
						}
